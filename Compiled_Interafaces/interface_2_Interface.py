...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon_path_list = os.path.join(script_dir, "..", "icons", "list.svg")
        icon_path_info = os.path.join(script_dir, "..", "icons", "info.svg")
        icon_path_printer = os.path.join(script_dir, "..", "icons", "printer.svg")
        icon_path_piston = os.path.join(script_dir, "..", "icons", "piston.svg")
        icon_path_search = os.path.join(script_dir, "..", "icons", "search.svg")
        icon_path_align_justify = os.path.join(script_dir, "..", "icons", "align-justify.svg")
        icon_path_settings = os.path.join(script_dir, "..", "icons", "settings.svg")
        icon_path_help = os.path.join(script_dir, "..", "icons", "help-circle.svg")

        # icon_path = os.path.join("..", "icons", "search.svg")
...
"")
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(icon_path_align_justify), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(icon_path_piston), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(icon_path_list), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(icon_path_printer), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(icon_path_settings), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(icon_path_info), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(icon_path_help), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(icon_path_search), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(icon_path_minimize), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(icon_path_maximize), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(icon_path_exit), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
# print(icon_path)
script_dir = os.path.dirname(os.path.abspath(__file__))
icon_path = os.path.join(script_dir, "..", "icons", "search.svg")
print("Το απόλυτο μονοπάτι για το εικονίδιο είναι:", icon_path)
print("Υπάρχει το αρχείο;", os.path.exists(icon_path))
